...
;(function($, Diaporama, undefined) {
    ...
    var loadingGifSrc = './image/loading2-32.gif',
        ajaxLikeImageUrl = './ajax/like_image_submit.php',
        ajaxUnlikeImageUrl = './ajax/like_image_submit.php';
    ...
    iPlayer.prototype = {
        ...
        getDiaporamaTimelineData: function(originData, containerWidth, containerHeight, displayTransitions) {
            ...
            for (var i = 0, len = originData.length; i < len; i++) {
                ...
                if (!originData[i].width) originData[i].width = containerWidth;
                if (!originData[i].height) originData[i].height = containerHeight;
